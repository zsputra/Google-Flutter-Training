...
// // List<Movie> fakeMovies = ListMovieFromJson(dummyMovies);
// List<Movie> coba(){

// List<Movie> fakeMovies  = List<Movie>();
// List<dynamic> decodedRaw = jsonDecode(dummyMovies);
// decodedRaw.forEach((x){
//   fakeMovies.add(Movie.fromJson(x));
// });
...
// // }''';
// //     Movie movies = Movie(id: "1", title: "Berenang", label: "label", priority: 1, poster: "poster", rating: 10, timestamp: 12331, viewed: true, year: "2020");
